...
def calculate_variant_entropy(pa, start_timestamp, end_timestamp, figure=False, base_filename=None, verbose=False):
	...
	if(figure):
		...
		plt.savefig(base_filename+"_Entropy_growth.png", dpi=600, bbox_inches='tight')
		plt.figure(figsize=(8, 6), dpi=600)
		df.plot("Date", ["Variant entropy(Active)", "Variant entropy(All)"])
		plt.savefig(base_filename+"_Entropy_growth_normalized.png", dpi=600, bbox_inches='tight')
		plt.close('all')
...
def calculate_sequence_entropy(pa, start_timestamp, end_timestamp, forgetting=None, k=1 ,figure=False, base_filename=None, verbose=False):
	...
	if(figure):
		if not forgetting:
			...
			plt.savefig(base_filename+"_Log_entropy_growth.png", dpi=600, bbox_inches='tight')
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", ["Sequence entropy(Active)", "Sequence entropy(All)"])
			plt.savefig(base_filename+"_Log_entropy_growth_normalized.png", dpi=600, bbox_inches='tight')
		elif(forgetting=="linear"):
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", "Sequence entropy(Rel)")
			plt.savefig(base_filename+"_Log_entropy_growth_linear_relative.png", dpi=600, bbox_inches='tight')
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", ["Sequence entropy(Rel,Active)", "Sequence entropy(Rel,All)"])
			plt.savefig(base_filename+"_Log_entropy_growth_linear_relative_normalized.png", dpi=600, bbox_inches='tight')
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", "Sequence entropy(Abs)")
			plt.savefig(base_filename+"_Log_entropy_growth_linear_absolute.png", dpi=600, bbox_inches='tight')
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", ["Sequence entropy(Abs,Active)", "Sequence entropy(Abs,All)"])
			plt.savefig(base_filename+"_Log_entropy_growth_linear_absolute_normalized.png", dpi=600, bbox_inches='tight')
		elif(forgetting=="exp"):
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", "Sequence entropy(Rel)")
			plt.savefig(base_filename+"_Log_entropy_growth_exp_relative.png", dpi=600, bbox_inches='tight')
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", ["Sequence entropy(Rel,Active)", "Sequence entropy(Rel,All)"])
			plt.savefig(base_filename+"_Log_entropy_growth_exp_relative_normalized.png", dpi=600, bbox_inches='tight')
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", "Sequence entropy(Abs)")
			plt.savefig(base_filename+"_Log_entropy_growth_exp_absolute.png", dpi=600, bbox_inches='tight')
			plt.figure(figsize=(8, 6), dpi=600)
			df.plot("Date", ["Sequence entropy(Abs,Active)", "Sequence entropy(Abs,All)"])
			plt.savefig(base_filename+"_Log_entropy_growth_exp_absolute_normalized.png", dpi=600, bbox_inches='tight')
		plt.close('all')
